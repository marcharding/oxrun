...
namespace MyNamespace\CustomCommand;
...
/**
 * Class ModuleSunCommand
 *
 * @package MyNamespace\CustomCommand
 */
class ModuleSunCommand extends Command implements EnableInterface
{
    /**
